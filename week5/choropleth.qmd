...
precip_data <- read_csv(here::here("data", "week5data", "county-nov20-oct25-precip.csv"), 
                        skip = 3)
# skip: skips the first three rows
...
# joining simple feature to a dataset, always put simple feature first
```
